...
public class Dungeon {
    ...
    //by Chris233
	//add a lua global for the game!
	public static Globals luaGlobal = JsePlatform.standardGlobals();
	public static StringBuilder luaLogBuilder = new StringBuilder();

	public static class LuaPrint extends LuaFunction{

		@Override
		public LuaValue call(LuaValue s) {
			luaLogBuilder.append(s.toString());
			luaLogBuilder.append("\n");
...
//
//			int i = 0;
//			while(! varargs.arg(i).isnil()) luaLogBuilder.append(varargs.arg(0).toString());
//
//			return super.onInvoke(varargs);
//		}
	}
